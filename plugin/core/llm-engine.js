...
(() => {
  ...
  // 方向区分：只报"店家主动"（让同事加您VX/给您回电）；"建议您加我们VX"是买家自己加，无需转办，不报。
  const FOLLOWUP_RE = /加(您|你|您的|你的|下).{0,6}(VX|vx|微信)|专员.{0,8}(对接|联系)|(让|叫|安排).{0,6}(同事|专员|负责人|店里).{0,8}(加|联系|对接|回电)|给(您|你)回(电|电话)|回(电|电话)给(您|你)|稍后.{0,8}(联系|加)(您|你)|反馈给(店里|负责人)/;
