...
| 连发合并 | ✓ | 买家趁处理间隙连发多句时合成一条理解，只回一条，不一句一答 |
...
```
cd plugin/tests
node agent-gate.test.mjs               # 门禁 23 项（历史/双推/角色/指纹/锁/人工静音/发送前再查静音/连发合并/needsHuman/关闭重开/跨买家隔离/两种 convId 格式分叉/人设包装）
